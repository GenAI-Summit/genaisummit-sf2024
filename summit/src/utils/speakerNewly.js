...
const speakerNewly = [
  ...
  */
  ...
  },
  {
    ...
    detail: muddu2,
    description: `Dr. Muddu Sudhakar is a Silicon Valley-based technocrat and serial entrepreneur named an EY Entrepreneur of the Year for 2023. Having built several applied AI companies acquired by some of the most celebrated companies in Silicon Valley (EMC, ServiceNow and Splunk) he is considered a prominent voice in AI/Machine Learning, IoT and Big Data. Aisera is one of the fastest-growing companies in America, with over 100 million active users at F1000 companies including Vistra, Snowflake, McAfee, Grant Thornton, Gap, Dave and many more. Dr. Sudhakar holds a Ph.D. and MS in Computer Science from UCLA in addition to being widely published in industry journals and conference proceedings and owns more than 40 patents.`,
  },
  {
    name: 'Philip Rathle',
    job: 'CTO',
